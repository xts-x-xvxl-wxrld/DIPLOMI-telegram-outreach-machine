...
class CommunityEngagementSettings(Base):
    ...
    max_posts_per_day: Mapped[int] = mapped_column(Integer, default=300, server_default="300", nullable=False)
    min_minutes_between_posts: Mapped[int] = mapped_column(Integer, default=1, server_default="1", nullable=False)
    ...
    quiet_hours_timezone: Mapped[str] = mapped_column(Text, default="utc", server_default="utc", nullable=False)
