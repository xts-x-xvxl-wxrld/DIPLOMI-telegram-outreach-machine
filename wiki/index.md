...
- `tests/test_bot_account_api_client.py`, `tests/test_bot_api_client.py`, `tests/test_bot_task_first_api_client.py`, `tests/test_telegram_account_onboarding_service.py`, `tests/test_bot_entrypoint.py` - bot HTTP client route/payload, task-first wizard route, account onboarding service, and Docker module entrypoint tests
