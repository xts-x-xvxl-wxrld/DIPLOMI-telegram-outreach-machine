...
- [Bot Engagement Controls](plan/bot-engagement-controls.md) - next bot slices for target admin, prompt/style controls, reply opportunity editing, and advanced settings; [Engagement Rollout Button](plan/engagement-rollout-button.md) - surface aggregate semantic rollout stats from the engagement bot admin UI
