...
from bot.api_client_engagement_admin import EngagementAdminApiClientMixin
...
class BotApiClient(AccountApiClientMixin, EngagementAdminApiClientMixin, SearchApiClientMixin):
    def __init__(
        self,
        *,
        base_url: str,
    ...
    async def get_engagement_cockpit_approvals(
        ...
        *,
        ...
        return await self._request("GET", "/engagement/cockpit/approvals", params=params or None)
    ...
    async def get_engagement_cockpit_issues(
        ...
        *,
        ...
        return await self._request("GET", "/engagement/cockpit/issues", params=params or None)
