...
def engagement_home_markup(*, show_admin: bool = True):
    rows = [
        ...
        [
            ...
            _button("✅ Approved", ACTION_ENGAGEMENT_CANDIDATES, "approved", "0"),
        ],
        [
...
def engagement_wizard_launch_markup(community_id: str):
    rows = [
        [_button("🚀 Start engagement", ACTION_ENGAGEMENT_WIZARD, "go", community_id)],
    ]
    return _inline_markup(_with_navigation(rows, back_action=ACTION_ENGAGEMENT_HOME))
...
def engagement_wizard_retry_markup(community_id: str):
    rows = [
        [_button("🔁 Retry", ACTION_ENGAGEMENT_WIZARD, "retry", community_id)],
    ]
    return _inline_markup(_with_navigation(rows, back_action=ACTION_ENGAGEMENT_HOME))
